...
!--------------------------------------------------------------------!
     ...
     &                      alphd,im_pick_up,Two_phase_mix,phai_m 
...
!Tsinghua group---------------------------------------------------
                if (Two_phase_mix==1) then
                  depo_mss=alphd*dt*Wsed(ised)*tr_el(indx,kbe(i)+1,i)*phai_m(kbe(i)+1,indx,i)
                else
...
!*****************************************************************************
      ...
      USE schism_glbl, ONLY : rkind,nea,nvrt,kbe,ze,pi,&
                               ...
                               rho0,grav,q2,i34,elnode,tr_el,refht,Tbp 
                               !Tsinghua group:+tr_el,refht,Tbp 
      USE schism_msgp
