...
!**********************************************************************
      ...
      integer :: fifteen_dims, IP, IPloc, IPglob, NP_RESloc, iProc
...
!**********************************************************************
      ...
      REAL(rkind) :: MaxNorm, SumNorm, p_is_converged,eFact, Sum_new,&
      &              DiffNew
      REAL(rkind), dimension(NUMSIG,NUMDIR) :: eSum, BSIDE, DIAG, WALOC&
      &                                       ,CAD,CAS, BLOC,ASPAR_DIAG&
      &                                       ,SSLIM, SSBRL
...
#endif
      integer :: JDX, IP, J, idx, nbIter, is_converged(1), itmp(1),&
      &          nbPassive
...
!**********************************************************************
      ...
      REAL(rkind), dimension(NUMSIG,NUMDIR), intent(out) :: eSum, ASPAR_DIAG
      integer :: ID1, ID2, ID, IS, IP_ADJ, IADJ
      REAL(rkind), dimension(NUMSIG,NUMDIR) :: NEG_P, CP_THE, CM_THE, CP_SIG, CM_SIG, &
                                             & A_THE, C_THE, A_SIG, C_SIG
