...
!REMY!
      ...
      do i=1,ntrs(3)
        ...
        call get_param('param.in','gen_wsett_'//ifile_char(1:ifile_len),2,itmp,gen_wsett(i),stringvalue)
      enddo
      tr_mname(3)='GEN'
#endif
#ifdef USE_AGE
...
!flag_model
      ...
      !#REMY#
      iwsett(irange_tr(1,3):irange_tr(2,3))=1
      if(myrank==0) write(16,*)'Generic tracer transport model evoked',irange_tr(1,3),irange_tr(2,3)
#endif
