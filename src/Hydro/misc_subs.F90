...
!     Local
      ...
      real(rkind) :: swild2(2)
      real(rkind),allocatable :: swild(:,:,:)
      logical, dimension(2) :: xchng, xchng_gb
...
!       See if the node/side exchange is needed
        call mpi_allreduce(xchng,xchng_gb,2,MPI_LOGICAL,MPI_LOR,comm,ierr)
...
!===============================================================================
     ...
     &zi*frame0(1:3,3)
      ...
      subroutine local_to_global_pt_project( xi,yi,zi,origin0,frame0,xo,yo,zo )
         use schism_glbl, only: rkind
         implicit none
         ...
         wild(1:3)=origin0(1:3)+xi*frame0(1:3,1)+yi*frame0(1:3,2)+zi*frame0(1:3,3)
         xo=wild(1)
         yo=wild(2)
         zo=wild(3)
      end subroutine local_to_global_pt_project

      subroutine global_to_local_pt_project( xi,yi,zi,origin0,frame0,xo,yo,zo )
         use schism_glbl, only: rkind
         implicit none
         ...
         yo=wild(2)
         zo=wild(3)
      end subroutine global_to_local_pt_project
...
!===============================================================================
      ...
      !Local
      integer :: j,nd,indx
      real(rkind) :: tmp,tmpmin,tmpmax,tmpsum,wild(3,2)
